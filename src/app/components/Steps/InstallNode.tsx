 ...
 useEffect(() => {
  ...
  return (
    <>
      ...
      {userOS === 'mac' && (
        <>
          <div className="callout" style={{ background: '#e3f2fd', borderColor: '#90caf9', color: '#0d47a1', marginTop: 'var(--space-3)', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      {downloadStarted && (
        <>
          <div className="callout" style={{ background: '#d4edda', borderColor: '#c3e6cb', color: '#155724', borderRadius: '12px', padding: 'var(--space-3)' }}>
            {isDownloading ? (
              <>
          ...
          <div className="callout" style={{ marginTop: 'var(--space-4)', background: '#fff3cd', borderColor: '#ffeaa7', color: '#856404', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      <div className="callout" style={{ background: '#fff3cd', borderColor: '#ffeaa7', color: '#856404', marginBottom: 'var(--space-2)', borderRadius: '12px', padding: 'var(--space-3)' }}>
