...
export default function SetupGitHubCopilot() {
  ...
  useEffect(() => {
    ...
    const os = localStorage.getItem('userOS') as 'windows' | 'mac' | null
    if (userInfo) {
      const parsedUserInfo = JSON.parse(userInfo)
      setUserName(`${parsedUserInfo.firstName} ${parsedUserInfo.lastName}`)
    }
    if (os) setUserOS(JSON.parse(os))
  }, [])
  ...
  return (
    <>
      ...
      {!userOS && (
        <div className="callout" style={{ background: '#fff3cd', borderColor: '#ffeaa7', color: '#856404', marginTop: 'var(--space-4)', borderRadius: '12px', padding: 'var(--space-3)' }}>
          <strong>Tip:</strong> Go back to Step 0 to select your operating system for customized keyboard shortcuts.
        </div>
      )}

      <div className="callout" style={{ background: '#e8f5e9', borderColor: '#a5d6a7', color: '#2e7d32', marginTop: 'var(--space-4)', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      <div className="callout" style={{ background: '#fff3cd', borderColor: '#ffeaa7', color: '#856404', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      <div className="callout" style={{ background: '#f0f4ff', borderColor: '#c5d7f7', color: '#1e3a8a', marginTop: 'var(--space-3)', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      <div className="callout" style={{ background: '#e8f5e9', borderColor: '#a5d6a7', color: '#2e7d32', marginTop: 'var(--space-3)', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      <div className="callout" style={{ background: '#fff3e0', borderColor: '#ffb74d', color: '#e65100', marginTop: 'var(--space-3)', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      <div className="callout" style={{ background: '#e3f2fd', borderColor: '#90caf9', color: '#1565c0', marginTop: 'var(--space-3)', borderRadius: '12px', padding: 'var(--space-3)' }}>
      ...
      <div className="callout" style={{ background: '#f0f4ff', borderColor: '#c5d7f7', color: '#1e3a8a', borderRadius: '12px', padding: 'var(--space-3)' }}>
